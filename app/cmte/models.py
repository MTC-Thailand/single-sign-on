...
class CMTEEventSponsor(db.Model):
    ...
    type = db.Column(db.String(), info={'label': 'ลักษณะขององค์กร',
             'choices': [(c, c) for c in (
                 'เปนสถาบันการศึกษา(คณะ/ภาควิชา/หนวยงานท่ีมีฐานะเทียบเทาคณะหรือภาควิชาท่ีผลิตบัณฑิตเทคนิคการแพทย) (โปรดระบุจำนวนอาจารยเทคนิคการแพทยในสังกัด(คน))',
                 'เปนสถาบันการศึกษา(คณะ/ภาควิชา/หนวยงานที่มีฐานะเทียบเทาคณะหรือภาควิชา)',
                 'เปนสถานพยาบาล (โปรดระบุ 1.ประเภทสถานพยาบาล 2.จํานวนเตียงรับผูปวย(เตียง) 3.จํานวนเทคนิคการแพทยในสังกัด(คน))',
                 'เปนหนวยงาน/องคกรตามที่สภาเทคนิคการแพทยประกาศกําหนด (โปรดระบุ)',
                 'เปนหนวยงาน/องคกรของรัฐหรือเอกชน (โปรดระบุ)')]})
